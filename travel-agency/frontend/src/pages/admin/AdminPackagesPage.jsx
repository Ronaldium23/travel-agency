            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              <div style={styles.formGrid}>
                ...
                <div style={styles.field}>
                  ...
                  <input type="number" name="totalSlots" value={form.totalSlots}
                    onChange={handleChange} required style={styles.input} />
                </div>
                <div style={styles.field}>
              ...
              <div style={styles.field}>
                ...
                <textarea name="includedServices" value={form.includedServices}
              ...
              <div style={styles.formGrid}>
                <div style={styles.field}>
                  ...
                  <textarea name="conditions" value={form.conditions}
                    onChange={handleChange} rows={2}
                    style={{ ...styles.input, resize: 'vertical' }} />
                </div>
                <div style={styles.field}>
                  <label style={styles.label}>Restricciones</label>
                  <textarea name="restrictions" value={form.restrictions}
                    onChange={handleChange} rows={2}
                    style={{ ...styles.input, resize: 'vertical' }} />
                </div>
              </div>
